  ...
  return (
    ...
    >
      ...
      <motion.div className="relative z-10 flex flex-col lg:flex-row gap-6 px-4 sm:px-6 md:px-8 py-6">
        <motion.div
          className="w-full lg:max-w-xs space-y-4"
        ...
        >
            ...
            <AnimatePresence>
              {jobs.map((job, index) => (
                ...
                >
                  ...
                  <p className="text-xs sm:text-sm text-gray-700 line-clamp-3 mb-4 flex-grow">
                    {job.description}
                  </p>
          ...
          <motion.div
            className="flex flex-wrap items-center justify-center gap-4 mt-8 px-4"
            variants={filterItemVariants}
          >
            <motion.button
              disabled={page <= 1}
